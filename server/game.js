...
function getTrainingCampOptions() {
  return [
    {
      id: "madrid",
      name: localize("Сбор в Мадриде", "Madrid camp"),
      cost: 650000,
      effect: localize("+мораль, +форма, шанс роста навыков", "+morale, +fitness, chance for skill growth"),
    },
    {
      id: "lisbon",
      name: localize("Сбор в Лиссабоне", "Lisbon camp"),
      cost: 420000,
      effect: localize("+мораль, +форма, техника", "+morale, +fitness, technical polish"),
    },
    {
      id: "dubai",
      name: localize("Сбор в Дубае", "Dubai camp"),
      cost: 980000,
      effect: localize("+мораль, +форма, усиленный рост навыков", "+morale, +fitness, bigger skill spike"),
    },
  ];
}
